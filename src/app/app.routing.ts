...
export const appRoutes: Route[] = [
    ...
    // Landing routes
    {
        ...
        children: [
            ...
            { path: 'mockui', loadChildren: () => import('app/views/mock-ui/mock-ui.module').then(m => m.MockUIModule) },
            { path: 'open-bill', loadChildren: () => import('app/components/open-bill/open-bill.module').then(m => m.OpenBillModule) },
            { path: 'transfer', loadChildren: () => import('app/components/transfer/transfer.module').then(m => m.TransferModule) },
            { path: 'check-transfer', loadChildren: () => import('app/components/check-transfer/check-transfer.module').then(m => m.CheckTransferModule) },
            { path: 'address', loadChildren: () => import('app/components/address/address.module').then(m => m.AddressModule) },
            { path: 'summary-order', loadChildren: () => import('app/components/summary-order/summary-order.module').then(m => m.SummaryOrderModule) },
            { path: 'show-orders', loadChildren: () => import('app/components/show-orders/show-orders.module').then(m => m.ShowOrdersModule) }
        ]
    },
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {
                path: 'sales', children: [
                    { path: 'chat', loadChildren: () => import('app/modules/sale-center/sale-center.module').then(m => m.SaleCenterModule) }
                ]
